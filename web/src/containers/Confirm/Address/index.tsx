...
class AddressComponent extends React.Component<Props, State> {
    ...
    private uploadFileSizeGuide = () => {
        if (barongUploadSizeMinRange) {
            return this.translate('page.body.kyc.address.uploadFile.sizeMinMax', barongUploadSizeMaxRange, barongUploadSizeMinRange);
        }

        return this.translate('page.body.kyc.address.uploadFile.sizeMax', barongUploadSizeMaxRange);
    };
